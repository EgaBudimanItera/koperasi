<div class="section-header">
  ...
  <a data-target="#tambah_agama" href="#" data-toggle="modal" id="tambah_mod_agama" style="text-decoration:none;" class="btn btn-primary btn-xs ml-auto"><i class="fa fa-plus-square" aria-hidden="true"></i> Tambah Data</a>
...
<table class="table table-sm dataTableExport table-bordered table-striped" style="width:100%">
          ...
          <?php foreach($list as $key => $val) { ?>
              <tr>
                  ...
                  <td>
                    <a id="<?=$val->agm_id?>"  href="#" class="btn btn-sm btn-warning ubah_agama"> <i class="fas fa-pencil-alt"></i> Ubah </a>
                    <a id="<?=$val->agm_id?>" class="btn btn-sm btn-danger text-white hapus_agama"> <i class="fas fa-trash"></i> Hapus </a> 
...
<!-- Modal Tambah agama -->
<div class="modal fade" tabindex="-1" role="dialog" id="tambah_agama" data-backdrop="false">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Tambah/Edit Agama</h5>
