    ...
    <div class="row">
        <div class="col-12 col-md-12 col-lg-12">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form id="form_anggota" autocomplete="off" name="form_anggota" method="POST">
                        ...
                        <div class="col-12 col-md-6 col-lg-6">
                            ...
                            <div class="card-body">
                                ...
                                <input type="text" id="ang_nomor" autocomplete="off" value="<?=$list->ang_nomor?>" readonly name="ang_nomor" class="form-control">
                                </div>
                                <div class="form-group">
                                <label>Nama Anggota</label>
                                <input type="text" id="ang_nama" autocomplete="off" name="ang_nama" value="<?=$list->ang_nama?>" class="form-control">
                                </div>
                                <div class="form-group">
                                <label>Tempat Lahir</label>
                                <input type="text" id="ang_tempat_lahir" autocomplete="off" value="<?=$list->ang_tempat_lahir?>" name="ang_tempat_lahir" class="form-control">
                                </div>
                                <div class="form-group">
                                <label>Tanggal Lahir</label>
                                <input type="text" id="ang_tanggal_lahir" autocomplete="off" readonly name="ang_tanggal_lahir" value="<?=date('d-m-Y',strtotime($list->ang_tanggal_lahir))?>" class="form-control datepicker">
                                </div>
                                <div class="form-group">
                                <label>Jenis Kelamin</label>
                                <select name="ang_jk" class="form-control" id="ang_jk" class="form-control" autocomplete="off" readonly>
                                ...
                                <div class="form-group">
                                <label>Agama</label>
                                <select name="ang_agm_id" id="ang_agm_id" class="form-control" autocomplete="off" readonly>
                                    <option value="">--Pilih--</option>
                                    <?php
                                ...
                                <select name="ang_krj_id" id="ang_krj_id" class="form-control" autocomplete="off" readonly>
                                    <option value="">--Pilih--</option>
                                    <?php
                                ...
                                <input type="text" id="ang_nama_ayah" value="<?=$list->ang_nama_ayah?>" autocomplete="off" name="ang_nama_ayah" class="form-control">
                                </div>
                                <div class="form-group">
                                <label>Nama Ibu</label>
                                <input type="text" id="ang_nama_ibu" value="<?=$list->ang_nama_ibu?>" autocomplete="off" name="ang_nama_ibu" class="form-control">
                                </div>
                                <div class="form-group">
                                <label>Alamat</label>
                                <textarea name="ang_alamat" id="ang_alamat" cols="30" rows="10" style="height:70%" autocomplete="off" class="form-control"><?=$list->ang_alamat?></textarea>
                                </div>
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-6">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                <label>No Hp</label>
                                <input type="text" name="ang_no_hp" autocomplete="off" value="<?=$list->ang_no_hp?>" id="ang_no_hp" class="form-control">
                                </div>
                                <div class="form-group">
                                <label>Jenis Dokumen Identitas</label>
                                <select name="ang_idn_id" id="ang_idn_id" autocomplete="off" readonly class="form-control">
                                    <option value="">--Pilih--</option>
                                    <?php
                                ...
                                <input type="text" id="ang_no_identitas" autocomplete="off" value="<?=$list->ang_no_identitas?>" name="ang_no_identitas" class="form-control">
                                </div>
                                <div class="form-group">
                                <label>Nama Ahli Waris</label>
                                <input type="text" id="ang_nama_ahli_waris" autocomplete="off" value="<?=$list->ang_nama_ahli_waris?>" name="ang_nama_ahli_waris" class="form-control">
                                </div>
                                <div class="form-group">
                                <label>Alamat Ahli Waris</label>
                                <textarea name="ang_alamat_ahli_waris" autocomplete="off" id="ang_alamat_ahli_waris" cols="30" rows="10" style="height:70%" class="form-control"><?=$list->ang_alamat_ahli_waris?></textarea>
                                </div>
                                <div class="form-group">
                                <label>Hubungan Keluarga</label>
                                <input type="text" id="ang_hub_keluarga" autocomplete="off" name="ang_hub_keluarga" value="<?=$list->ang_hub_keluarga?>" class="form-control">
                                </div>
                            </div>
                            </div>
                        </div>
