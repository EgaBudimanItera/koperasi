  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form_anggota" autocomplete="off" name="form_anggota"  method="POST" onSubmit="return confirm('yakin Untuk menyimpan?');">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" id="ang_nomor" autocomplete="off" value="<?=$nomor_anggota?>" readonly name="ang_nomor" class="form-control">
                    </div>
                    <div class="form-group">
                      <label>Tanggal Daftar</label>
                      <input type="text" id="dft_tanggal_daftar" readonly autocomplete="off" value="<?=date('d-m-Y')?>" name="dft_tanggal_daftar" class="form-control datepicker">
                    </div>
                    <div class="form-group">
                      <label>Nama Anggota</label>
                      <input type="text" require id="ang_nama" autocomplete="off" autocomplete="off" name="ang_nama" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" require id="ang_tanggal_lahir" autocomplete="off" readonly name="ang_tanggal_lahir" class="form-control datepicker">
                    </div>
                    <div class="form-group">
                      <label>Jenis Kelamin</label>
                      <select name="ang_jk" class="form-control" id="ang_jk" autocomplete="off" readonly require class="form-control">
                    ...
                    <div class="form-group">
                      <label>Agama</label>
                      <select name="ang_agm_id" id="ang_agm_id" require readonly autocomplete="off" class="form-control">
                          <option value="">--Pilih--</option>
                          <?php
                    ...
                    <div class="form-group">
                      ...
                      <select name="ang_krj_id" id="ang_krj_id" readonly autocomplete="off" require class="form-control">
                          <option value="">--Pilih--</option>
                          <?php
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="ang_nama_ayah" require autocomplete="off" name="ang_nama_ayah" class="form-control">
                    </div>
                    <div class="form-group">
                      <label>Nama Ibu</label>
                      <input type="text" id="ang_nama_ibu" require autocomplete="off" name="ang_nama_ibu" class="form-control">
                    </div>
                    <div class="form-group">
                      <label>Alamat</label>
                      <textarea name="ang_alamat" id="ang_alamat" require autocomplete="off" cols="30" rows="10" style="height:70%" class="form-control"></textarea>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <select name="ang_idn_id" id="ang_idn_id" require autocomplete="off" readonly class="form-control">
                          <option value="">--Pilih--</option>
                          <?php
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="ang_no_identitas" require autocomplete="off" name="ang_no_identitas" class="form-control">
                    </div>
                    <div class="form-group">
                      <label>Nama Ahli Waris</label>
                      <input type="text" id="ang_nama_ahli_waris" require autocomplete="off" name="ang_nama_ahli_waris" class="form-control">
                    </div>
                    <div class="form-group">
                      <label>Alamat Ahli Waris</label>
                      <textarea name="ang_alamat_ahli_waris" require autocomplete="off" id="ang_alamat_ahli_waris" cols="30" rows="10" style="height:70%" class="form-control"></textarea>
                    </div>
                    <div class="form-group">
                      <label>Hubungan Keluarga</label>
                      <input type="text" id="ang_hub_keluarga" require autocomplete="off" name="ang_hub_keluarga" class="form-control">
                    </div>
                  </div>
                </div>
              </div>
